...
namespace A2
{
    class SalaryOfficialEmployees: Staff //Creates a new class called "SalaryOfficialEmployees" that inherits from the "Staff" class. 
    {
        ...
        int year;
        public int IdOE { get; private set; }
        public int Bonus { get; set; }

        public SalaryOfficialEmployees()
        {
            IdOE = GenerateOfficialEmployeeID(); // Automatically Generate Official Employee ID
        }
        ...
        {
            Console.WriteLine($"Official Employee's ID: OE{IdOE}\n- Full name: {FullName}\n- Age: {Age}\n- Address: {Address}\n- Phone Number: {PhoneNumber}" +
